...
let ReturnTableColumnData = ({ inJsonConfig, inItemConfig, inUserName }) => {
    ...
    if (LocalUserPK > 0) {
        ...
        LocalTableColumnData = _.get(LocalDataFromJSON, `${LocalItemName}.${LocalScreenName}.${CommonColumnKey}`);
...
let ReturnTableColumnDataElement = ({ inJsonConfig, inItemConfig, inUserName, inKeyName }) => {
    ...
    let LocalColumnData = _.find(LocalTableColumnData, { DataAttribute: LocalColumnName });
