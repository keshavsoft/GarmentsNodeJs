let jFUpdateFunc = () => {
    let jVarLocalUpdateClassName = document.getElementsByClassName("CreateColumnButtonClass");
...
let jFLocalClickFunc = async (event) => {
    ...
    let jFetchUrl = "/JSONAdminApi/AdminApi/AsTree/Json/UserFolders/ScreensFromDisplayJson/SubTableColumns/CreateNew/CreateNew";
